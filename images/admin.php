...
<div id="sortable-list" class="hd-b">Raw(<?php echo  count($datamodel); ?>)</div>
...
<div class="min-hd"><?php echo strtoupper($datamode['retail']);?></div></a>
...
<div class="box-min-3">
<div class="hd-b">Not Interested(<?php echo  count($instt); ?>)</div>
<div id="sortable-list" class="box-tx">
<div id="dvDestb">
<?php if (isset($instt)){ ?>
...
<div class="box-min-4">
<div class="hd-b">Awaiting feedback(<?php echo  count($sads); ?>)</div>
<div id="sortable-list" class="box-tx">
<div id="dvDestc">
<?php if (isset($sads)){ ?>
